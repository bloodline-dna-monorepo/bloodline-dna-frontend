    ...
    >
      <div className="container flex items-center justify-between">
        <Link to="/" className="flex items-center">
          <img src="/logo.png" alt="Gen Unity Logo" className="h-16" />
        </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="container py-4 space-y-3">
            <Link to="/" className="block py-2 hover:text-[var(--primary)]" onClick={() => setIsMobileMenuOpen(false)}>
              Home
            </Link>
            <Link
              to="/about"
            ...
            <Link to="/auth" className="btn btn-primary w-full text-center" onClick={() => setIsMobileMenuOpen(false)}>
              Sign In / Register
            </Link>
          </div>
        </div>
