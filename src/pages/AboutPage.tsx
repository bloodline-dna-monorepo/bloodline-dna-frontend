    ...
    <div className="pt-12 font-['Inter'] antialiased bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] text-white py-8 rounded-lg mb-6">
        <div className="container mx-auto max-w-3xl text-center">
          <h1 className="text-5xl font-bold mb-3 leading-tight">About Gen Unity</h1>
          <p className="text-base mb-3 max-w-xl mx-auto">
      ...
      <section className="py-6 px-3">
        <div className="container mx-auto max-w-3xl">
          <div className="grid grid-cols-2 gap-6 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-3">Our Mission: Unlocking Genetic Potential</h2>
              <p className="text-base mb-3">
                ...
                uncompromising accuracy, complete privacy, and compassionate supports.
              </p>
              <p className="text-base mb-3">
            ...
            <div className="relative flex justify-center items-center p-3 bg-white rounded-lg shadow">
              <img
                src={ourImage}
                alt="Our Mission"
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Integrity & Accuracy</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Privacy & Security</h3>
              <p className="text-base text-gray-600 leading-relaxed">
      ...
      <section className="bg-gray-100 py-8 px-3 rounded-lg shadow-inner my-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-6">Why Choose Gen Unity?</h2>
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-[var(--primary)] mb-3 flex justify-center">
                <CheckCircle size={48} strokeWidth={2} />
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Certified Accuracy</h3>
              <p className="text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Unwavering Privacy</h3>
              <p className="text-base text-gray-600 leading-relaxed">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:scale-105 transition-transform duration-300">
              ...
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Emily Chen</h3>
            ...
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:scale-105 transition-transform duration-300">
              <img
                ...
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg font-semibold mb-2">Michael Davis</h3>
            ...
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:scale-105 transition-transform duration-300">
              <img
                ...
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Alex Kim</h3>
      ...
      <section className="bg-gray-100 py-8 px-3">
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold text-black mb-4">State-of-the-Art Technology</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-base">Next-Generation Sequencing</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-base">Automated Sample Processing</span>
                    <div className="text-gray-600 text-base">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-base">Secure Digital Results Platform</span>
                    <div className="text-gray-600 text-base">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:shadow-lg transition-all hover:-translate-y-2">
              ...
              <span className="text-gray-800 text-base font-medium text-center">FPT University</span>
            </div>
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:shadow-lg transition-all hover:-translate-y-2">
              <div className="h-20 w-28 bg-gray-200 rounded mb-4 overflow-hidden flex items-center justify-center">
                <img src={yduoc} alt="yduoc" className="h-full w-full object-cover bg-white" />
              </div>
              <span className="text-gray-800 text-base font-medium text-center">Ho Chi Minh City University of Medicine and Pharmacy</span>
            </div>
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:shadow-lg transition-all hover:-translate-y-2">
              <div className="h-20 w-28 bg-gray-200 rounded mb-4 overflow-hidden flex items-center justify-center">
                <img src={havard} alt="Harvard" className="h-full w-full object-cover" />
              </div>
              <span className="text-gray-800 text-base font-medium text-center">Harvard International University</span>
            </div>
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:shadow-lg transition-all hover:-translate-y-2">
              <div className="h-20 w-28 bg-gray-200 rounded mb-4 overflow-hidden flex items-center justify-center">
                <img src={tuvu} alt="tu vu" className="h-full w-full object-cover" />
              </div>
              <span className="text-gray-800 text-base font-medium text-center">Tu Vu Hospital Ho Chi Minh City</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-[var(--secondary)] to-[var(--primary)] text-white py-10 px-3 rounded-lg shadow-lg mt-8">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Unlock Your DNA Story?</h2>
          ...
          <div className="flex justify-center items-center">
            <button
              className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-medium text-lg hover:bg-white hover:text-[var(--primary)] transition duration-300"
              onClick={() => navigate('/services')}
            >
              Learn More About Our Tests
            </button>
          </div>
          <div className="mt-8 flex justify-center items-center gap-6 text-sm opacity-90">
