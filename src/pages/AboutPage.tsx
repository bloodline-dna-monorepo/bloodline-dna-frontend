    ...
    <div className="pt-12 font-['Inter'] antialiased bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] text-white py-8 rounded-lg mb-6">
        <div className="container mx-auto max-w-3xl text-center">
          <h1 className="md:text-6xl font-bold mb-3 leading-tight">About Gen Unity</h1>
          <p className="text-sm md:text-lg mb-3 max-w-xl mx-auto">
      ...
      <section className="py-6 px-2">
        <div className="container mx-auto max-w-3xl">
          <div className="grid lg:grid-cols-2 gap-4 items-center">
            <div>
              <h2 className="text-xl md:text-4xl font-bold mb-3">Our Mission: Unlocking Genetic Potential</h2>
            ...
            <div className="relative order-1 lg:order-2 flex justify-center items-center p-2 bg-white rounded-md shadow">
              <img
                src={ourImage}
                alt="Our Mission"
      ...
      {/* Core Values Section */}
      <section className="bg-gray-100 py-10 px-3 rounded-lg shadow-inner my-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-2xl md:text-5xl font-bold mb-6">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-[var(--primary)] mb-2 flex justify-center">
                <Shield size={40} strokeWidth={2} />
              </div>
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Integrity & Accuracy</h3>
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Compassionate Care</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Privacy & Security</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Innovation</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Excellence</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Community</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
      ...
      <section className="bg-gray-100 py-10 px-3 rounded-lg shadow-inner my-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-2xl md:text-5xl font-bold mb-6">Why Choose Gen Unity?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-[var(--primary)] mb-2 flex justify-center">
                <CheckCircle size={40} strokeWidth={2} />
              </div>
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Certified Accuracy</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Unwavering Privacy</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Expert Support</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Advanced Technology</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Personalized Insights</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-md shadow hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-2xl font-semibold text-gray-800 mb-1">Trusted by Thousands</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
      ...
      {/* Team Section */}
      <section className="bg-gray-800 text-white py-10 px-3 rounded-lg my-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-2xl md:text-4xl font-bold mb-5">Meet Our Dedicated Team</h2>
          <p className="text-base md:text-xl opacity-80 mb-6 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gray-700 p-4 rounded-md shadow hover:scale-105 transition-transform duration-300">
              <img
                src={menber1}
                alt="Team Member 1"
                className="w-28 h-28 rounded-full mx-auto mb-3 object-cover border-2 border-[var(--primary)]"
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg md:text-xl font-semibold mb-1">Dr. Emily Chen</h3>
              <p className="text-base text-gray-300">Lead Geneticist</p>
              <p className="text-sm text-gray-400 mt-1">Specializing in genomic sequencing and analysis.</p>
            </div>
            <div className="bg-gray-700 p-4 rounded-md shadow hover:scale-105 transition-transform duration-300">
              <img
                src={menber2}
                alt="Team Member 2"
                className="w-28 h-28 rounded-full mx-auto mb-3 object-cover border-2 border-[var(--secondary)]"
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg md:text-xl font-semibold mb-1">Michael Davis</h3>
              <p className="text-base text-gray-300">Bioinformatics Engineer</p>
              <p className="text-sm text-gray-400 mt-1">Developing advanced data processing algorithms.</p>
            </div>
            <div className="bg-gray-700 p-4 rounded-md shadow hover:scale-105 transition-transform duration-300">
              <img
                src={menber3}
                ...
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg md:text-xl font-semibold mb-1">Sarah Lee</h3>
              <p className="text-base text-gray-300">Customer Relations Lead</p>
              <p className="text-sm text-gray-400 mt-1">Ensuring a seamless and supportive client experience.</p>
            </div>
            <div className="bg-gray-700 p-4 rounded-md shadow hover:scale-105 transition-transform duration-300">
              <img
                src={menber4}
                ...
                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/E0F2FE/1E40AF?text=Image+Not+Found"; }}
              />
              <h3 className="text-lg md:text-xl font-semibold mb-1">Dr. Alex Kim</h3>
              <p className="text-base text-gray-300">Medical Advisor</p>
              <p className="text-sm text-gray-400 mt-1">Providing clinical expertise and guidance.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid lg:grid-cols-2 gap-6 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-xl md:text-4xl font-bold text-black mb-3">State-of-the-Art Technology</h2>
              <p className="text-sm md:text-xl text-gray-900 mb-4 max-w-3xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="text-green-600 mt-1 mr-2">
                    <svg width={25} height={25} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                      <path d="M5 13l4 4L19 7" />
                    </svg>
                  </span>
                  <div>
                    <span className="font-medium text-sm md:text-lg">Next-Generation Sequencing</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-sm md:text-lg">Automated Sample Processing</span>
                    <div className="text-gray-600 text-xs md:text-base">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-sm md:text-lg">Secure Digital Results Platform</span>
                    <div className="text-gray-600 text-xs md:text-base">
            ...
            <div className="order-1 lg:order-2 flex justify-center items-center">
              <img
                ...
                className="rounded-lg w-full max-w-md h-auto shadow-md"
                onError={(e) => {
      ...
      <section className="bg-gray-50 py-8 px-3">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-xl md:text-4xl font-bold text-gray-900 mb-3">Our Partners &amp; Accreditations</h2>
          <p className="text-sm md:text-xl text-gray-700 mb-6 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center hover:shadow-md transition-all hover:-translate-y-1">
              <div className="h-18 w-28 bg-gray-200 rounded mb-3 overflow-hidden flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-[var(--secondary)] to-[var(--primary)] text-white py-10 px-3 rounded-lg shadow mt-6" >
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-2xl md:text-4xl font-bold mb-3">Ready to Unlock Your DNA Story?</h2>
          <p className="text-base md:text-xl opacity-90 mb-6 max-w-3xl mx-auto">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-6 justify-center items-center text-sm opacity-90">
