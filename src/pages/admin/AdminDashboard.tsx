...
const COLORS = ["#2196f3", "#00bcd4", "#ffeb3b", "#ab47bc", "#f44336"]
            ...
            <div className="flex justify-between mt-4 px-2">
              {["T1", "T2", "T3", "T4", "T5", "T6"].map((label, idx) => (
                <div key={label} className="text-center">
                  ...
                  <div className="text-xs text-gray-400">{data.monthlyRevenue[idx] || 0} test</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="ml-6 mt-4 md:mt-0">
                {["ADN cha con", "ADN 2", "ADN 3", "ADN 4", "Khác"].map((label, idx) => (
                  <div key={label} className="flex items-center mb-2">
                    ...
                    <span className="text-sm">
                      {label} <b>{data.serviceDistribution[idx] || 0}</b>
                      {totalDoughnut > 0 && (
