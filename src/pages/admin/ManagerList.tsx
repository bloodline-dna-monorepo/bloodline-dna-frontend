...
// Giả lập fetch dữ liệu manager từ database (API)
    ...
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow border p-6">
        <div className="flex justify-between items-center mb-2">
          <span className="text-lg font-semibold border-l-4 border-blue-400 pl-2">Manager List</span>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
            ...
            <tbody>
              ...
              {mana.length === 0 && (
                <tr>
                  <td colSpan={5} className="text-center py-4 text-gray-400">No managers found.</td>
                </tr>
              )}
            </tbody>
          </table>
