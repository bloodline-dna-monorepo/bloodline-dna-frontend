...
const TestProcess: React.FC = () => {
    ...
    const initialSteps = [
        {
            id: 1,
            title: 'Đã hàng thuần công',
            description: 'Mẫu đã được chuẩn bị và xử lý ban đầu',
            completedDate: '2024-03-01 14:30'
        },
        {
            id: 2,
            title: 'Qua xét nghiệm',
            description: 'Tiến hành xét nghiệm mẫu ADN',
            completedDate: '2024-03-01 16:30'
        },
        {
            id: 3,
            title: 'Đã xác minh mẫu',
            description: 'Xác minh và kiểm tra chất lượng mẫu',
            completedDate: null
        },
        {
            id: 4,
            title: 'Nhập kết quả và có xác cao minh',
            description: 'Nhập kết quả và xác nhận cuối cùng',
            completedDate: null
        },
        {
            id: 5,
            title: 'Nhập kết quả và có xác cao minh',
            description: 'Hoàn tất và gửi kết quả cho khách hàng',
            completedDate: null
        }
    ]
                    ...
                    <div className='p-6'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                            <div>
                                ...
                                <span className='ml-2 text-gray-900'>{requestData.customerName}</span>
                            </div>
                            <div>
                                <span className='text-gray-500'>Thông tin liên hệ:</span>
                            ...
                            <div>
                                <span className='text-gray-500'>Số lượng mẫu:</span>
                                <span className='ml-2 text-gray-900'>{requestData.sampleCount} người</span>
                            </div>
                            <div>
                                <span className='text-gray-500'>Địa điểm:</span>
                                <div className='ml-2 text-gray-900'>
                                    <div>Tại nhà 621 TP.HCM</div>
                                    <div>Quận 1</div>
                ...
                <div className='bg-white rounded-lg shadow-sm border border-gray-200'>
                    <div className='p-6'>
                        <div className='flex items-center justify-between mb-6'>
                            <h3 className='text-lg font-semibold text-gray-900'>Tiến trình</h3>
